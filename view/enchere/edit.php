{{ include('header.php', {title: 'Enchere Edit'}) }}

    <div class="enchere-create">
        <form enctype="multipart/form-data" action="{{path}}enchere/update" method="post">
        <label>Date de début
            ...
            <label>Titre du timbre
                <textarea type="text" name="nom" value="{{enchereShow.nom}}">{{enchereShow.nom}}</textarea>
            </label>
            <label>Description du timbre
                <textarea type="text" name="description" value="{{enchereShow.description}}">{{enchereShow.description}}</textarea>
            </label>
            ...
            <input type="hidden" name="timbre_id" value="{{ enchereShow.timbre_id }}">
